                                    ...
                                    <table class="table table-md">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="customRadio{{ $i.'1' }}" name="module[{{ $i }}][view][]" value="1" {{ get_permission_access_value('views', $module, 1) }} class="custom-control-input">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="customRadio{{ $i.'3' }}" name="module[{{ $i }}][create][]" value="1" {{ get_permission_access_value('creates', $module, 1) }} class="custom-control-input">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="customRadio{{ $i.'5' }}" name="module[{{ $i }}][edit][]" value="1" {{ get_permission_access_value('edits', $module, 1) }} class="custom-control-input">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="customRadio{{ $i.'7' }}" name="module[{{ $i }}][delete][]" value="1" {{ get_permission_access_value('deletes', $module, 1) }} class="custom-control-input">
