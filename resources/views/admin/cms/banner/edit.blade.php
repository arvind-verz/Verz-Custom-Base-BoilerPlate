...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            ...
            <h1>{{ $title ?? '-' }}</h1>
            @include('admin.inc.breadcrumb', ['breadcrumbs' => Breadcrumbs::generate('admin_banner_crud', 'Edit', route('banner.edit', $banner->id))])
        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" name="banner_image" class="custom-file-input" id="customFile1">
                                    ...
                                    <div  class="d-block">
                                        <a href="{{ asset($banner->banner_image) }}" target="_blank"><img src="{{ asset($banner->banner_image) }}" alt="" width="200px"></a>
                                    </div>
                                    @endif
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="position" class="form-control" id="">
                                        ...
                                        <option value="{{ $key }}" @if($banner->position==$key) selected @elseif($key==1) selected
                                            @endif>{{ $item }}
                                        </option>
                                        @endforeach
                                        @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control" id="">
                                        ...
                                        <option value="{{ $key }}" @if($banner->status==$key) selected @elseif($key==1) selected
                                            @endif>{{ $item }}
                                        </option>
                                        @endforeach
                                        @endif
